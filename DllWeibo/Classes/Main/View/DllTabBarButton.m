...
#define DllImageRatio 0.7

@interface DllTabBarButton ()

@property (nonatomic, weak) DllBadgeView *badgeView;

@end

@implementation DllTabBarButton

// 重写setHighLighted，取消高亮
-(void)setHighlighted:(BOOL)highlighted{}

//懒加载badgeView
-(DllBadgeView *)badgeView{
    
    if (_badgeView == nil) {
        
        DllBadgeView *btn = [DllBadgeView buttonWithType:UIButtonTypeCustom];
...
-(void)layoutSubviews{
    ...
    CGFloat imageH = self.height * DllImageRatio;
